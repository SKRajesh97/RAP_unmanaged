CLASS lhc_Travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    ...
    METHODS validateAgency FOR VALIDATE
      ON SAVE
...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD get_instance_features.
    ...
    READ ENTITIES OF zi_rap_travel1_1234 IN LOCAL MODE
    ENTITY Travel
  ...
  METHOD acceptTravel.
    ...
    MODIFY ENTITIES OF zi_rap_travel1_1234 IN LOCAL MODE
    ENTITY travel
    UPDATE
  ...
  METHOD validateAgency.
    ...
    LOOP AT travels INTO DATA(travel).
      ...
      IF travel-AgencyId IS INITIAL OR NOT line_exists( agencies_db[ agency_id = travel-AgencyID ] ).
        ...
        APPEND VALUE #( %tky = travel-%tky
                        %state_area = 'VALIDATE_AGENCY'
                        %msg = NEW zcm_rap1_1234(
                                    severity = if_abap_behv_message=>severity-error
                                    textid = zcm_rap1_1234=>agency_unknown
  ...
  METHOD validateCustomer.
    ...
    "Raise msg for non existing and initial cusotmerID
    LOOP AT travels INTO DATA(travel).
      ...
      IF travel-CustomerId IS INITIAL OR NOT line_exists( customer_db[ customer_id = travel-CustomerId ] ).
        ...
        APPEND VALUE #( %tky = travel-%tky
                        ...
                        %msg = NEW zcm_rap1_1234(
                                   severity = if_abap_behv_message=>severity-error
                                   textid = zcm_rap1_1234=>customer_unknown
    ...
    LOOP AT travels INTO DATA(travel).
      ...
      IF travel-EndDate < travel-BeginDate.
        ...
        APPEND VALUE #( %tky     = travel-%tky
                        ...
                        %msg      = NEW zcm_rap1_1234(
                                        severity = if_abap_behv_message=>severity-error
                                        textid = zcm_rap1_1234=>date_interval
      ...
      ELSEIF travel-BeginDate < cl_abap_context_info=>get_system_date(  ).
        ...
        APPEND VALUE #( %tky = travel-%tky
                        ...
                        %msg  = NEW zcm_rap1_1234(
                                 severity = if_abap_behv_message=>severity-error
                                 textid = zcm_rap1_1234=>begin_date_before_system_date
                                 begindate = travel-BeginDate )
      ...
      IF is_update_requested = abap_true.
        ...
        IF has_before_image = abap_true.
          ...
          IF update_granted = abap_false.
            APPEND VALUE #( %tky        = travel-%tky
                            %msg        = NEW zcm_rap1_1234( severity = if_abap_behv_message=>severity-error
                                                            textid   = zcm_rap1_1234=>unauthorized )
                          ) TO reported-travel.
          ENDIF.
